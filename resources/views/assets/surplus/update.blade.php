...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Modificar sobrante
                    <a class="btn btn-outline btn-danger" href="/surplus">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form role="form" method="POST" action="{{ route('surplus.update', $asset->id) }}" enctype="multipart/form-data">
