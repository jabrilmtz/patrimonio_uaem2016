...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-11">
                <h1 class="page-header">Normales</h1>
            </div>
            <!-- /.col-lg-12 -->
            <div class="col-lg-1">
                <span class="center"><br><br>
                    <p>
                        <a class="btn btn-outline btn-primary" href="normal/create">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Bienes con los que cuenta la institución (etiqueta gris)
                    </div>
                    <!-- /.panel-heading -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover table-responsive" id="dataTables-example">
                                ...
                                @foreach($assets as $asset)
                                    <tr class="gradeU">
                                        ...
                                        <td>{{$user->name}}</td>
                                        <td class="center">
                                            <a class="btn btn-warning btn-circle" href="normal/{{ $asset->id }}/edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-success btn-circle" data-toggle="modal" data-target="#modalAssets-{{ $asset->id }}">
                                                <i class="fa fa-eye"></i>
                                            </button>
                                            <form action="{{ route('normal.destroy', $asset->id) }}" method="POST">
                                            ...
                                            @if($asset->category == "Sin revisar")
                                                <a class="btn btn-info btn-circle" href="normal/{{ $asset->id }}/scan">
