...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-11">
                <h1 class="page-header">Pre-registros</h1>
            </div>
            <!-- /.col-lg-12 -->
            <div class="col-lg-1">
                <span class="center"><br><br>
                    <p>
                        <a class="btn btn-outline btn-primary" href="preregister/create">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Bienes pre-registrados (etiqueta blanca)
                    </div>
                    <!-- /.panel-heading -->
                                ...
                                @foreach($assets as $asset)
                                    <tr class="gradeU">
                                        <?php
                                            ...
                                            //Se extrae la información de las unidades académicas
                                            $unit = \App\Entities\Unit::find($asset->unit_id);
                                        ...
                                        <td>{{$user->name}}</td>
                                        <td class="center">
                                            <a class="btn btn-warning btn-circle" href="preregister/{{ $asset->id }}/edit">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-success btn-circle" data-toggle="modal" data-target="#modalAssets-{{ $asset->id }}">
                                                <i class="fa fa-eye"></i>
                                            </button>
                                            <form action="{{ route('preregister.destroy', $asset->id) }}" method="POST">
                                            ...
                                            @if($asset->category == "Sin revisar")
                                            <a class="btn btn-info btn-circle" href="preregistered/{{ $asset->id }}/scan">
