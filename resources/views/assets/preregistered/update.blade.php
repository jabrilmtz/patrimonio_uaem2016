...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Modificar pre-registro
                    <a class="btn btn-outline btn-danger" href="/preregistered">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <form role="form" method="POST" action="{{ route('preregister.update', $asset->id) }}" enctype="multipart/form-data">
