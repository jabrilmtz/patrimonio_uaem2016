...
@section('content')
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Modificar encargado
                            ...
                            <form role="form" method="POST" action="{{ route('employee.update', $employee->id) }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="code" value="{{ $employee->code }}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label>Email*</label>
                                        <input type="email" class="form-control" name="email"
                                               placeholder="ejemlo@gmail.com" value="{{ $employee->email }}">
                                        @if($errors->has('email'))
