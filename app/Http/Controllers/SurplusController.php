...
class SurplusController extends Controller
{
    ...
    {
        // Se extraen todos los bienes sobrantes de la base de datos
        $assets = Asset::all();
        $assets = $assets->where('status_id','==','3');
        return view('assets.surplus.index')->with('assets',$assets);
    }
    ...
    public function create()
    {
        ...
        return view('assets.surplus.create')->with('brands',$brands)->with('providers',$providers)
    ...
    public function edit($id)
    {
        ...
        $programs = Program::all();
        $assets_types = AssetsType::all();
        return view('assets.surplus.update')->with('asset',$asset)->with('brands',$brands)->with('providers',$providers)
            ->with('programs',$programs)->with('assets_types',$assets_types);
    }
